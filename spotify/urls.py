...
urlpatterns = [
    ...
    path('artists/<str:pk>/albums/play', views.ArtistPlay.as_view(), name='partist'),
    path('albums/<str:pk>/tracks/play', views.AlbumPlay.as_view(), name='palbum'),
    path('tracks/<str:pk>/play', views.TrackPlay.as_view(), name='ptrack')
]